...
!(function (a) {
    ...
    c = function (d, e) {
      ...
      function i(a, b) {
        ...
        d.observe(a, {
          ...
          characterData:
            "undefined" == typeof b.characterData ? !0 : b.characterData,
        }),
          t.observers.push(d);
      }
      function j(a) {
        ...
        if (
          ...
          ((t.isHorizontal() && 39 === b) || (!t.isHorizontal() && 40 === b))
        )
          return !1;
        if (
          !t.params.allowSwipeToPrev &&
          ((t.isHorizontal() && 37 === b) || (!t.isHorizontal() && 38 === b))
        )
          return !1;
        if (
          !(
      ...
      function k(a) {
        ...
        if (0 !== c) {
          if ((t.params.mousewheelInvert && (c = -c), t.params.freeMode)) {
            var e =
                t.getWrapperTranslate() + c * t.params.mousewheelSensitivity,
              f = t.isBeginning,
              g = t.isEnd;
            if (
      ...
      for (var p in e)
        if (
          ...
          e[p] === window ||
          e[p] === document ||
          ("undefined" != typeof Dom7 && e[p] instanceof Dom7) ||
          ("undefined" != typeof jQuery && e[p] instanceof jQuery)
        )
          o[p] = e[p];
        else {
          o[p] = {};
      ...
      for (var r in b)
        if ("undefined" == typeof e[r]) e[r] = b[r];
        else if ("object" == typeof e[r])
          for (var s in b[r])
            "undefined" == typeof e[r][s] && (e[r][s] = b[r][s]);
      var t = this;
      if (
        ((t.params = e),
        (t.originalParams = o),
        ...
        (t.setBreakpoint = function () {
          ...
          if (a && t.currentBreakpoint !== a) {
            var b =
                a in t.params.breakpoints
                  ? t.params.breakpoints[a]
                  : t.originalParams,
        ...
        (t.container[0].swiper = t),
          ...
          t.params.pagination &&
            ...
            t.paginationContainer.addClass(
              "swiper-pagination-" + t.params.paginationType
            )),
          ...
          (t.preloadImages = function () {
            ...
            for (var b = 0; b < t.imagesToLoad.length; b++)
              t.loadImage(
                t.imagesToLoad[b],
                t.imagesToLoad[b].currentSrc ||
                  t.imagesToLoad[b].getAttribute("src"),
                t.imagesToLoad[b].srcset ||
                  t.imagesToLoad[b].getAttribute("srcset"),
                !0,
                a
              );
          }),
          ...
          (t.startAutoplay = function () {
            return "undefined" != typeof t.autoplayTimeoutId
              ...
              ? t.autoplaying
                ? !1
                : ((t.autoplaying = !0), t.emit("onAutoplayStart", t), void g())
              : !1;
          }),
          ...
          (t.pauseAutoplay = function (a) {
            t.autoplayPaused ||
              ...
              (t.autoplayPaused = !0),
              0 === a
                ? ((t.autoplayPaused = !1), g())
                : t.wrapper.transitionEnd(function () {
                    t &&
                      ((t.autoplayPaused = !1),
                      t.autoplaying ? g() : t.stopAutoplay());
                  }));
          }),
          ...
          (t.updateSlidesSize = function () {
            ...
            if ("undefined" != typeof t.size) {
                ...
                "none" !== l.css("display") &&
                  ("auto" === t.params.slidesPerView
                    ? ((h = t.isHorizontal()
                        ? l.outerWidth(!0)
                        : l.outerHeight(!0)),
                      t.params.roundLengths && (h = f(h)))
                    : ((h =
                        (t.size - (t.params.slidesPerView - 1) * b) /
                        t.params.slidesPerView),
                      t.params.roundLengths && (h = f(h)),
                      t.isHorizontal()
                        ? (t.slides[a].style.width = h + "px")
                        : (t.slides[a].style.height = h + "px")),
                  ...
                  t.params.centeredSlides
                    ? ((c = c + h / 2 + d / 2 + b),
                      ...
                      e % t.params.slidesPerGroup === 0 && t.snapGrid.push(c),
                      t.slidesGrid.push(c))
                    : (e % t.params.slidesPerGroup === 0 && t.snapGrid.push(c),
                      t.slidesGrid.push(c),
                      (c = c + h + b)),
              ...
              if (
                ...
                for (p = [], a = 0; a < t.snapGrid.length; a++)
                  t.snapGrid[a] < t.virtualSize + t.snapGrid[0] &&
                    p.push(t.snapGrid[a]);
                t.snapGrid = p;
              }
              if (!t.params.centeredSlides) {
                for (p = [], a = 0; a < t.snapGrid.length; a++)
                  t.snapGrid[a] <= t.virtualSize - t.size &&
                    p.push(t.snapGrid[a]);
                (t.snapGrid = p),
          ...
          (t.updateSlidesOffset = function () {
            for (var a = 0; a < t.slides.length; a++)
              t.slides[a].swiperSlideOffset = t.isHorizontal()
                ? t.slides[a].offsetLeft
                : t.slides[a].offsetTop;
          }),
          (t.updateSlidesProgress = function (a) {
            if (
              ...
              for (var c = 0; c < t.slides.length; c++) {
                var d = t.slides[c],
                  e =
                    (b - d.swiperSlideOffset) /
                    (d.swiperSlideSize + t.params.spaceBetween);
            ...
            for (b = 0; b < t.slidesGrid.length; b++)
              "undefined" != typeof t.slidesGrid[b + 1]
                ? d >= t.slidesGrid[b] &&
                  d <
                    t.slidesGrid[b + 1] -
                      (t.slidesGrid[b + 1] - t.slidesGrid[b]) / 2
                  ? (a = b)
                  : d >= t.slidesGrid[b] &&
                    d < t.slidesGrid[b + 1] &&
                    (a = b + 1)
          ...
          (t.updateClasses = function () {
            ...
            t.params.loop &&
              0 === c.length &&
              t.slides.eq(0).addClass(t.params.slideNextClass);
            var d = b
            ...
            if (
              (t.params.loop &&
                0 === d.length &&
                t.slides.eq(-1).addClass(t.params.slidePrevClass),
              ...
              if (
                (t.params.loop
                  ? ((e = Math.ceil(
                    ...
                    e > t.slides.length - 1 - 2 * t.loopedSlides &&
                ...
                t.isHorizontal() || ((i = g), (h = 1)),
                  t.paginationContainer
                    ...
                    .transform(
                      "translate3d(0,0,0) scaleX(" + h + ") scaleY(" + i + ")"
                    )
              ...
              "custom" === t.params.paginationType &&
                ...
                (t.paginationContainer.html(
                  t.params.paginationCustomRender(t, e + 1, f)
                ),
          ...
          (t.updatePagination = function () {
            if (
              ...
              "fraction" === t.params.paginationType &&
                ...
                t.paginationContainer.html(a)),
                "progress" === t.params.paginationType &&
                  ((a = t.params.paginationProgressRender
          ...
          (t.onResize = function (a) {
            ...
            (t.params.allowSwipeToPrev = t.params.allowSwipeToNext = !0),
              t.updateContainerSize(),
              t.updateSlidesSize(),
              ("auto" === t.params.slidesPerView || t.params.freeMode || a) &&
                t.updatePagination(),
              t.params.scrollbar && t.scrollbar && t.scrollbar.set(),
              t.controller &&
                t.controller.spline &&
        ...
        window.navigator.pointerEnabled
          ...
          (t.touchEvents = {
            start:
              t.support.touch || !t.params.simulateTouch ? "touchstart" : v[0],
            move:
              t.support.touch || !t.params.simulateTouch ? "touchmove" : v[1],
          ...
          (t.initEvents = function (a) {
            ...
            t.browser.ie
              ? (d[c](t.touchEvents.start, t.onTouchStart, !1),
                f[c](t.touchEvents.move, t.onTouchMove, g),
                f[c](t.touchEvents.end, t.onTouchEnd, !1))
              : (t.support.touch &&
                  (d[c](t.touchEvents.start, t.onTouchStart, !1),
                  d[c](t.touchEvents.move, t.onTouchMove, g),
                  d[c](t.touchEvents.end, t.onTouchEnd, !1)),
                !e.simulateTouch ||
                  t.device.ios ||
                  t.device.android ||
                  (d[c]("mousedown", t.onTouchStart, !1),
              ...
              t.params.nextButton &&
                t.nextButton &&
                t.nextButton.length > 0 &&
                (t.nextButton[b]("click", t.onClickNext),
                t.params.a11y &&
                  t.a11y &&
                  t.nextButton[b]("keydown", t.a11y.onEnterKey)),
              t.params.prevButton &&
                t.prevButton &&
                t.prevButton.length > 0 &&
                (t.prevButton[b]("click", t.onClickPrev),
                t.params.a11y &&
                  t.a11y &&
                  t.prevButton[b]("keydown", t.a11y.onEnterKey)),
              t.params.pagination &&
                t.params.paginationClickable &&
                (t.paginationContainer[b](
                  "click",
                  "." + t.params.bulletClass,
                  t.onClickIndex
                ),
          ...
          (t.preventClicks = function (a) {
            t.allowClick ||
              (t.params.preventClicks && a.preventDefault(),
            ...
            if (
              ...
              if (t.params.loop) {
                ...
                (f = a(t.clickedSlide).attr("data-swiper-slide-index")),
                  t.params.centeredSlides
                    ? g < t.loopedSlides - t.params.slidesPerView / 2 ||
                      g >
                        t.slides.length -
                          t.loopedSlides +
                      ...
                      : t.slideTo(g)
                    : g > t.slides.length - t.params.slidesPerView
                    ? (t.fixLoop(),
                      (g = t.wrapper
                        .children(
                          "." +
        ...
        if (
          ((t.onTouchStart = function (b) {
            if (
              ...
              (J = "touchstart" === b.type),
              J || !("which" in b) || 3 !== b.which)
            ) {
              if (t.params.noSwiping && h(b, "." + t.params.noSwipingClass))
                return void (t.allowClick = !0);
              if (!t.params.swipeHandler || h(b, t.params.swipeHandler)) {
                var c = (t.touches.currentX =
                    "touchstart" === b.type
                      ? b.targetTouches[0].pageX
                      : b.pageX),
                  d = (t.touches.currentY =
                    "touchstart" === b.type
                      ? b.targetTouches[0].pageY
                      : b.pageY);
                if (
                  !(
                    t.device.ios &&
                    t.params.iOSEdgeSwipeDetection &&
                    c <= t.params.iOSEdgeSwipeThreshold
                  )
                ) {
                  if (
                    ((w = !0),
          ...
          (t.onTouchMove = function (b) {
            if (
              ...
              if (
                ...
                return (x = !0), void (t.allowClick = !1);
              if (
                (y && t.emit("onTouchMove", t, b),
                ...
                if (
                  ...
                  var c =
                    ...
                    Math.PI;
                  A = t.isHorizontal()
                    ? c > t.params.touchAngle
                    : 90 - c > t.params.touchAngle;
                }
                if (
                  (A && t.emit("onTouchMoveOpposite", t, b),
                  "undefined" == typeof K &&
                    t.browser.ieTouch &&
                  ...
                  if (K || !t.browser.ieTouch) {
                    (t.allowClick = !1),
                      ...
                      (x = !0);
                    var d = (t.touches.diff = t.isHorizontal()
                      ? t.touches.currentX - t.touches.startX
                      : t.touches.currentY - t.touches.startY);
                    ...
                    if (
                      ...
                      if (t.params.threshold > 0) {
                        if (!(Math.abs(d) > t.params.threshold || D))
                          return void (B = C);
                        if (!D)
                          return (
                            (D = !0),
            ...
            if (
              ...
              if (
                (t.allowClick &&
                    ...
                    (E = setTimeout(function () {
                      t &&
                        (t.params.paginationHide &&
                          t.paginationContainer.length > 0 &&
                          !a(b.target).hasClass(t.params.bulletClass) &&
                  ...
                  300 > d &&
                    300 > c - H &&
                    (E && clearTimeout(E), t.emit("onDoubleTap", t, b))),
                (H = Date.now()),
                setTimeout(function () {
                  t && (t.allowClick = !0);
                }, 0),
              ...
              if (
                ...
                if (t.params.freeModeMomentum) {
                  ...
                  if (l < t.maxTranslate())
                    ...
                    t.params.freeModeMomentumBounce
                      ? (l - t.minTranslate() > o && (l = t.minTranslate() + o),
                        (m = t.minTranslate()),
                        (n = !0),
                        (F = !0))
                      : (l = t.minTranslate());
                    ...
                    (l =
                      Math.abs(t.snapGrid[p] - l) <
                        Math.abs(t.snapGrid[p - 1] - l) ||
                      "next" === t.swipeDirection
                        ? t.snapGrid[p]
                        : t.snapGrid[p - 1]),
                      t.rtl || (l = -l);
                ...
                return void (
                  (!t.params.freeModeMomentum || d >= t.params.longSwipesMs) &&
              ...
              for (r = 0; r < t.slidesGrid.length; r += t.params.slidesPerGroup)
                "undefined" != typeof t.slidesGrid[r + t.params.slidesPerGroup]
                  ? e >= t.slidesGrid[r] &&
                    e < t.slidesGrid[r + t.params.slidesPerGroup] &&
                    ((s = r),
                    (u =
                      t.slidesGrid[r + t.params.slidesPerGroup] -
                      t.slidesGrid[r]))
                  : e >= t.slidesGrid[r] &&
                    ((s = r),
                    (u =
              ...
              if (d > t.params.longSwipesMs) {
                ...
                "next" === t.swipeDirection &&
                  (v >= t.params.longSwipesRatio
                    ? t.slideTo(s + t.params.slidesPerGroup)
                    : t.slideTo(s)),
                  "prev" === t.swipeDirection &&
                    (v > 1 - t.params.longSwipesRatio
                      ? t.slideTo(s + t.params.slidesPerGroup)
                      : t.slideTo(s));
              } else {
          ...
          (t.slideTo = function (a, b, c, d) {
            ...
            t.params.autoplay &&
              t.autoplaying &&
              (d || !t.params.autoplayDisableOnInteraction
                ? t.pauseAutoplay(b)
                : t.stopAutoplay()),
              t.updateProgress(e);
            for (var f = 0; f < t.slidesGrid.length; f++)
              -Math.floor(100 * e) >= Math.floor(100 * t.slidesGrid[f]) &&
                (a = f);
            return !t.params.allowSwipeToNext &&
              ...
              : ("undefined" == typeof b && (b = t.params.speed),
                ...
                (t.rtl && -e === t.translate) || (!t.rtl && e === t.translate)
                  ? (t.params.autoHeight && t.updateAutoHeight(),
                    t.updateClasses(),
                    "slide" !== t.params.effect && t.setWrapperTranslate(e),
                    !1)
                  : (t.updateClasses(),
          ...
          (t.setWrapperTranslate = function (a, b, c) {
            ...
            t.isHorizontal() ? (d = t.rtl ? -a : a) : (e = a),
              ...
              t.params.virtualTranslate ||
                (t.support.transforms3d
                  ? t.wrapper.transform(
                      "translate3d(" + d + "px, " + e + "px, " + g + "px)"
                    )
                  : t.wrapper.transform("translate(" + d + "px, " + e + "px)")),
            ...
            (h = 0 === i ? 0 : (a - t.minTranslate()) / i),
              ...
              t.params.control &&
                t.controller &&
                t.controller.setTranslate(t.translate, c),
          ...
          (t.getWrapperTranslate = function (a) {
            return (
              "undefined" == typeof a && (a = t.isHorizontal() ? "x" : "y"),
          ...
          (t.initObservers = function () {
            if (t.params.observeParents)
              for (var a = t.container.parents(), b = 0; b < a.length; b++)
                i(a[b]);
            i(t.container[0], {
              childList: !1,
            }),
          ...
          (t.createLoop = function () {
            ...
            "auto" !== t.params.slidesPerView ||
              ...
              (t.params.loopedSlides = b.length),
            ...
            for (
              ...
              t.wrapper.append(
                a(e[c].cloneNode(!0)).addClass(t.params.slideDuplicateClass)
              );
            for (c = d.length - 1; c >= 0; c--)
              t.wrapper.prepend(
                a(d[c].cloneNode(!0)).addClass(t.params.slideDuplicateClass)
              );
          }),
          ...
          (t.fixLoop = function () {
            ...
            t.activeIndex < t.loopedSlides
              ? ((a = t.slides.length - 3 * t.loopedSlides + t.activeIndex),
                (a += t.loopedSlides),
                t.slideTo(a, 0, !1, !0))
              : (("auto" === t.params.slidesPerView &&
                ...
                ((a = -t.slides.length + t.activeIndex + t.loopedSlides),
                (a += t.loopedSlides),
                t.slideTo(a, 0, !1, !0));
          }),
          ...
          (t.removeSlide = function (a) {
            ...
            t.params.loop && t.createLoop(),
              (t.params.observer && t.support.observer) || t.update(!0),
              t.params.loop
                ? t.slideTo(c + t.loopedSlides, 0, !1)
                : t.slideTo(c, 0, !1);
          }),
            ...
            fade: {
              setTranslate: function () {
                for (var a = 0; a < t.slides.length; a++) {
                  ...
                  var f = t.params.fade.crossFade
                    ? Math.max(1 - Math.abs(b[0].progress), 0)
                    : 1 + Math.min(Math.max(b[0].progress, -1), 0);
                  b.css({
                    opacity: f,
              ...
              setTransition: function (a) {
                if (
                  (t.slides.transition(a), t.params.virtualTranslate && 0 !== a)
                ) {
                  var b = !1;
                ...
                for (var b = 0; b < t.slides.length; b++) {
                  ...
                  if (
                    (t.isHorizontal()
                      ...
                      : ((j = i), (i = 0), (h = -g), (g = 0)),
                    (c[0].style.zIndex =
                      -Math.abs(Math.round(d)) + t.slides.length),
                    t.params.flip.slideShadows)
                  ) {
                    var k = t.isHorizontal()
            ...
            cube: {
              setTranslate: function () {
                ...
                t.params.cube.shadow &&
                  (t.isHorizontal()
                    ? ((b = t.wrapper.find(".swiper-cube-shadow")),
                      0 === b.length &&
                    ...
                    : ((b = t.container.find(".swiper-cube-shadow")),
                      0 === b.length &&
                        ((b = a('<div class="swiper-cube-shadow"></div>')),
                        t.container.append(b))));
                for (var d = 0; d < t.slides.length; d++) {
                  ...
                  d % 4 === 0
                    ...
                    : (d - 3) % 4 === 0 &&
                      ((i = -t.size), (k = 3 * t.size + 4 * t.size * g)),
                    t.rtl && (i = -i),
              ...
              setTransition: function (a) {
                t.slides
                  ...
                  t.params.cube.shadow &&
                    !t.isHorizontal() &&
                    t.container.find(".swiper-cube-shadow").transition(a);
              },
            },
            coverflow: {
              setTranslate: function () {
                for (
                  var b = t.translate,
                    c = t.isHorizontal() ? -b + t.width / 2 : -b + t.height / 2,
                    d = t.isHorizontal()
          ...
          (t.lazy = {
            ...
            loadImageInSlide: function (b, c) {
              if (
                "undefined" != typeof b &&
                ("undefined" == typeof c && (c = !0), 0 !== t.slides.length)
              ) {
                var d = t.slides.eq(b),
                  e = d.find(
                    ".swiper-lazy:not(.swiper-lazy-loaded):not(.swiper-lazy-loading)"
                  );
                !d.hasClass("swiper-lazy") ||
                  d.hasClass("swiper-lazy-loaded") ||
                  d.hasClass("swiper-lazy-loading") ||
                  (e = e.add(d[0])),
                  0 !== e.length &&
                    e.each(function () {
                      var b = a(this);
                      ...
                      t.loadImage(b[0], f || e, g, !1, function () {
                        if (
                          (e
                            ...
                            : (g &&
                              ...
                              f &&
                                (b.attr("src", f), b.removeAttr("data-src"))),
                          b
            ...
            load: function () {
              ...
              if (t.params.watchSlidesVisibility)
                ...
                for (
                  b = t.activeIndex;
                  b < t.activeIndex + t.params.slidesPerView;
                  b++
                )
                  t.slides[b] && t.lazy.loadImageInSlide(b);
              ...
              if (t.params.lazyLoadingInPrevNext)
                if (
                  ...
                  var c = t.params.lazyLoadingInPrevNextAmount,
                    ...
                    e = Math.min(
                      t.activeIndex + d + Math.max(c, d),
                      t.slides.length
                    ),
                    f = Math.max(t.activeIndex - Math.max(d, c), 0);
                  for (b = t.activeIndex + t.params.slidesPerView; e > b; b++)
                    t.slides[b] && t.lazy.loadImageInSlide(b);
                  for (b = f; b < t.activeIndex; b++)
                    t.slides[b] && t.lazy.loadImageInSlide(b);
                } else {
          ...
          (t.scrollbar = {
            ...
            setDragPosition: function (a) {
              var b = t.scrollbar,
                ...
                d =
                  c -
                  b.track.offset()[t.isHorizontal() ? "left" : "top"] -
                  b.dragSize / 2,
              ...
              if (t.params.scrollbar) {
                ...
                (b.track = a(t.params.scrollbar)),
                  t.params.uniqueNavElements &&
                    ...
                    (b.track = t.container.find(t.params.scrollbar)),
                  ...
                  (b.trackSize = t.isHorizontal()
                    ? b.track[0].offsetWidth
                    : b.track[0].offsetHeight),
            ...
            setTranslate: function () {
              if (t.params.scrollbar) {
                ...
                (a = (b.trackSize - b.dragSize) * t.progress),
                  ...
                  t.isHorizontal()
                    ? (t.support.transforms3d
                        ? b.drag.transform("translate3d(" + a + "px, 0, 0)")
                        : b.drag.transform("translateX(" + a + "px)"),
                      (b.drag[0].style.width = c + "px"))
                    : (t.support.transforms3d
                        ? b.drag.transform("translate3d(0px, " + a + "px, 0)")
                        : b.drag.transform("translateY(" + a + "px)"),
            ...
            getInterpolateFunction: function (a) {
              t.controller.spline ||
                (t.controller.spline = t.params.loop
                  ? new t.controller.LinearSpline(t.slidesGrid, a.slidesGrid)
                  : new t.controller.LinearSpline(t.snapGrid, a.snapGrid));
            },
              ...
              function d(b) {
                (a =
                  ...
                  "slide" === t.params.controlBy &&
                    (t.controller.getInterpolateFunction(b),
                    (f = -t.controller.spline.interpolate(-a))),
                  (f && "container" !== t.params.controlBy) ||
                    ((e =
          ...
          (t.disableKeyboardControl = function () {
            (t.params.keyboardControl = !1), a(document).off("keydown", j);
          }),
          (t.enableKeyboardControl = function () {
            (t.params.keyboardControl = !0), a(document).on("keydown", j);
          }),
          (t.mousewheel = {
            event: !1,
          ...
          try {
            ...
            (window.WheelEvent ||
              (t.container[0] && "wheel" in t.container[0])) &&
        ...
        (t.disableMousewheelControl = function () {
          return t.mousewheel.event
            ? (t.container.off(t.mousewheel.event, k), !0)
            : !1;
        }),
          (t.enableMousewheelControl = function () {
            return t.mousewheel.event
              ? (t.container.on(t.mousewheel.event, k), !0)
              : !1;
          }),
          (t.parallax = {
            setTranslate: function () {
              ...
              "undefined" == typeof b && (b = t.params.speed),
                t.container
                  ...
                  .each(function () {
                    var c = a(this),
                      d =
                        parseInt(c.attr("data-swiper-parallax-duration"), 10) ||
                        b;
        ...
        return (
          ...
          (t.emit = function (a) {
            ...
            if (t.emitterEventListeners[a])
              for (b = 0; b < t.emitterEventListeners[a].length; b++)
                t.emitterEventListeners[a][b](
                  arguments[1],
                  arguments[2],
                  arguments[3],
                  arguments[4],
          ...
          (t.off = function (a, b) {
            ...
            if (((a = m(a)), "undefined" == typeof b))
              return (t.emitterEventListeners[a] = []), t;
            if (
              t.emitterEventListeners[a] &&
              0 !== t.emitterEventListeners[a].length
            ) {
              for (c = 0; c < t.emitterEventListeners[a].length; c++)
                t.emitterEventListeners[a][c] === b &&
                  t.emitterEventListeners[a].splice(c, 1);
              return t;
            }
          }),
          (t.once = function (a, b) {
  ...
  (g =
    "undefined" == typeof Dom7
      ...
      : Dom7),
    g &&
      ("transitionEnd" in g.fn ||
        (g.fn.transitionEnd = function (a) {
          function b(f) {
            if (f.target === this)
        ...
        if (0 !== d.length)
          for (var e = 0; e < d.length; e++) {
            var f,
              g = d.eq(e);
            g.data("swiper")
              ? g.data("swiper").update(!0)
              : ((f = g.dataset()), a.swiper(g[0], f));
          }
      }),
  ...
  +(function (a) {
    ...
    var b = function (b) {
      ...
      d.params = b;
      var g =
          d.params.navbarTemplate ||
          '<header class="bar bar-nav"><a class="icon icon-left pull-left photo-browser-close-link' +
            ("popup" === d.params.type ? " close-popup" : "") +
            '"></a><h1 class="title"><div class="center sliding"><span class="photo-browser-current"></span> <span class="photo-browser-of">' +
            d.params.ofText +
            '</span> <span class="photo-browser-total"></span></div></h1></header>',
        h =
          d.params.toolbarTemplate ||
          '<nav class="bar bar-tab"><a class="tab-item photo-browser-prev" href="#"><i class="icon icon-prev"></i></a><a class="tab-item photo-browser-next" href="#"><i class="icon icon-next"></i></a></nav>',
        i =
          d.params.template ||
          '<div class="photo-browser photo-browser-' +
            d.params.theme +
            '">{{navbar}}{{toolbar}}<div data-page="photo-browser-slides" class="content">{{captions}}<div class="photo-browser-swiper-container swiper-container"><div class="photo-browser-swiper-wrapper swiper-wrapper">{{photos}}</div></div></div></div>',
        j = d.params.lazyLoading
          ? d.params.photoLazyTemplate ||
            '<div class="photo-browser-slide photo-browser-slide-lazy swiper-slide"><div class="preloader' +
              ("dark" === d.params.theme ? " preloader-white" : "") +
              '"></div><span class="photo-browser-zoom-container"><img data-src="{{url}}" class="swiper-lazy"></span></div>'
          : d.params.photoTemplate ||
            '<div class="photo-browser-slide swiper-slide"><span class="photo-browser-zoom-container"><img src="{{url}}"></span></div>',
        k = d.params.captionsTheme || d.params.theme,
        l =
          d.params.captionsTemplate ||
          '<div class="photo-browser-captions photo-browser-captions-' +
            k +
            '">{{captions}}</div>',
        m =
          d.params.captionTemplate ||
          '<div class="photo-browser-caption" data-caption-index="{{captionIndex}}">{{caption}}</div>',
        n =
          d.params.objectTemplate ||
          '<div class="photo-browser-slide photo-browser-object-slide swiper-slide">{{html}}</div>',
        o = "",
        p = "";
        ...
        "string" == typeof q || q instanceof String
          ? (r =
              q.indexOf("<") >= 0 || q.indexOf(">") >= 0
                ...
                : j.replace(/{{url}}/g, q))
          : "object" == typeof q &&
            (q.hasOwnProperty("html") && q.html.length > 0
              ? (r = n.replace(/{{html}}/g, q.html))
              : q.hasOwnProperty("url") &&
                q.url.length > 0 &&
                (r = j.replace(/{{url}}/g, q.url)),
            q.hasOwnProperty("caption") && q.caption.length > 0
              ? (p += m
                  .replace(/{{caption}}/g, q.caption)
                  .replace(/{{captionIndex}}/g, c))
              : (r = r.replace(/{{caption}}/g, ""))),
          (o += r);
      }
      var s = i
        .replace("{{navbar}}", d.params.navbar ? g : "")
        .replace("{{noNavbar}}", d.params.navbar ? "" : "no-navbar")
        .replace("{{photos}}", o)
        .replace("{{captions}}", l.replace(/{{captions}}/g, p))
        .replace("{{toolbar}}", d.params.toolbar ? h : "");
      (d.activeIndex = d.params.initialSlide),
        (d.openIndex = d.activeIndex),
        (d.opened = !1),
        (d.open = function (b) {
          return (
            "undefined" == typeof b && (b = d.activeIndex),
            (b = parseInt(b, 10)),
            d.opened && d.swiper
              ? void d.swiper.slideTo(b)
              : ((d.opened = !0),
                (d.openIndex = b),
                "standalone" === d.params.type &&
                  a(d.params.container).append(s),
                "popup" === d.params.type &&
                  ((d.popup = a.popup(
                    '<div class="popup photo-browser-popup">' + s + "</div>"
                  )),
                ...
                "page" === d.params.type
                  ? (a(document).on("pageBeforeInit", d.onPageBeforeInit),
                    ...
                    void d.params.view.loadContent(s))
                  : (d.layout(d.openIndex),
        ...
        (d.close = function () {
          (d.opened = !1),
            d.swiperContainer &&
              0 !== d.swiperContainer.length &&
              (d.params.onClose && d.params.onClose(d),
              d.attachEvents(!0),
              "standalone" === d.params.type &&
                d.container
        ...
        (d.onPageBeforeInit = function (b) {
          "photo-browser-slides" === b.detail.page.name &&
            d.layout(d.openIndex),
        ...
        (d.onSliderTransitionStart = function (b) {
          ...
          if (
            ...
            a(".photo-browser-prev, .photo-browser-next").removeClass(
              "photo-browser-link-inactive"
            ),
            b.isBeginning &&
              !d.params.loop &&
              a(".photo-browser-prev").addClass("photo-browser-link-inactive"),
            b.isEnd &&
              !d.params.loop &&
              a(".photo-browser-next").addClass("photo-browser-link-inactive"),
            d.captions.length > 0)
          ) {
            d.captionsContainer
        ...
        (d.onSliderTransitionEnd = function (a) {
          d.params.zoom &&
            ...
            (u.transform("translate3d(0,0,0) scale(1)"),
        ...
        (d.layout = function (b) {
          "page" === d.params.type
            ? (d.container = a(".photo-browser-swiper-container").parents(
                ".view"
              ))
            : (d.container = a(".photo-browser")),
            "standalone" === d.params.type &&
              d.container.addClass("photo-browser-in"),
            (d.swiperContainer = d.container.find(
              ".photo-browser-swiper-container"
            )),
            (d.swiperWrapper = d.container.find(
          ...
          d.params.swipeToClose &&
            "page" !== d.params.type &&
            ((c.onTouchStart = d.swipeCloseTouchStart),
        ...
        (d.toggleExposition = function () {
          d.container && d.container.toggleClass("photo-browser-exposed"),
            d.params.expositionHideCaptions &&
              d.captionsContainer.toggleClass("photo-browser-captions-exposed"),
            (d.exposed = !d.exposed);
        }),
        (d.enableExposition = function () {
          d.container && d.container.addClass("photo-browser-exposed"),
            d.params.expositionHideCaptions &&
              d.captionsContainer.addClass("photo-browser-captions-exposed"),
            (d.exposed = !0);
        }),
        (d.disableExposition = function () {
          d.container && d.container.removeClass("photo-browser-exposed"),
            d.params.expositionHideCaptions &&
              d.captionsContainer.removeClass("photo-browser-captions-exposed"),
            (d.exposed = !1);
        });
      var t,
        u,
      ...
      (d.onSlideGestureStart = function () {
        return t ||
          ...
          0 !== v.length)
          ? (u.transition(0), void (y = !0))
          : void (u = void 0);
      }),
        (d.onSlideGestureChange = function (a) {
          u &&
            0 !== u.length &&
            ((w = (a.scale || a.originalEvent.scale) * x),
            w > d.params.maxZoom &&
              (w =
                d.params.maxZoom - 1 + Math.pow(w - d.params.maxZoom + 1, 0.5)),
            w < d.params.minZoom &&
              (w =
                d.params.minZoom + 1 - Math.pow(d.params.minZoom - w + 1, 0.5)),
            u.transform("translate3d(0,0,0) scale(" + w + ")"));
        }),
        (d.onSlideGestureEnd = function () {
          u &&
            0 !== u.length &&
            ((w = Math.max(Math.min(w, d.params.maxZoom), d.params.minZoom)),
            u
              .transition(d.params.speed)
              .transform("translate3d(0,0,0) scale(" + w + ")"),
            (x = w),
            (y = !1),
            1 === w && (t = void 0));
        }),
        (d.toggleZoom = function () {
          t ||
            ((t = d.swiper.slides.eq(d.swiper.activeIndex)),
            (u = t.find("img, svg, canvas")),
            (v = u.parent(".photo-browser-zoom-container"))),
            u &&
              0 !== u.length &&
              (v.transition(300).transform("translate3d(0,0,0)"),
              w && 1 !== w
                ? ((w = x = 1),
                  u.transition(300).transform("translate3d(0,0,0) scale(1)"),
                  (t = void 0))
                : ((w = x = d.params.maxZoom),
                  u
                    .transition(300)
                    .transform("translate3d(0,0,0) scale(" + w + ")")));
        });
      ...
      (d.onSlideTouchStart = function (b) {
        u &&
          0 !== u.length &&
          (z ||
            ("android" === a.device.os && b.preventDefault(),
            (z = !0),
            (Q = a.getTouchPosition(b))));
      }),
        (d.onSlideTouchMove = function (b) {
          if (u && 0 !== u.length && ((d.swiper.allowClick = !1), z && t)) {
            ...
            if (!(c < d.swiper.width && e < d.swiper.height)) {
              if (
                ((D = Math.min(d.swiper.width / 2 - c / 2, 0)),
                (F = -D),
                (E = Math.min(d.swiper.height / 2 - e / 2, 0)),
                (G = -E),
                (R = a.getTouchPosition(b)),
                !A &&
                  !y &&
                  ((Math.floor(D) === Math.floor(J) && R.x < Q.x) ||
                    (Math.floor(F) === Math.floor(J) && R.x > Q.x)))
              )
                return void (z = !1);
              b.preventDefault(),
                b.stopPropagation(),
                ...
                (B = R.x - Q.x + J),
                (C = R.y - Q.y + K),
                D > B && (B = D + 1 - Math.pow(D - B + 1, 0.8)),
                B > F && (B = F - 1 + Math.pow(B - F + 1, 0.8)),
                E > C && (C = E + 1 - Math.pow(E - C + 1, 0.8)),
                C > G && (C = G - 1 + Math.pow(C - G + 1, 0.8)),
                L || (L = R.x),
                O || (O = R.y),
                M || (M = Date.now()),
      ...
      var S,
        ...
        Z = !1;
      return (
        (d.swipeCloseTouchStart = function () {
          Y && (X = !0);
        }),
        ...
        (d.swipeCloseTouchEnd = function () {
          ...
          return (300 > c && b > 20) || (c >= 300 && b > 100)
            ...
            : (0 !== b
                ? V.addClass("transitioning").transitionEnd(function () {
