/* GET https://appoint.yihu.com/appoint/js/register/orderFormComm.js?v=20211027 HTTP/1.1
...
Accept: 
Cookie: YiHu_OpenId=eyJPcGVuSUQiOiJvZDBBandKMGVvZERZWUE0cFVmRFJVQ0lJbThFIiwiU2VjU3RyIjoiQjQwQTEzOTVGQjI1RkQ2MzRDRDkyNjA2MkM2M0UxQTUifQ%3D%3D; logintype=62; loginprovinceid=0; logincityid=0; loginid=od0AjwJ0eodDYYA4pUfDRUCIIm8E; OpenID=od0AjwJ0eodDYYA4pUfDRUCIIm8E; BaseDoctorUid=0; BaseUserType=0; LoginChannel=9000370; TOKEN_28BF437073E3440D653DCFCFB15BCD93=FB6065A93DCE43DDA6A5168BACD7D72B; _YyghSysTrackUUID=11095502857; jkzlAn_uuid=CFA1F5AA-ED7D-414B-900E-67982A6F03D0; jkzlAn_sid=EA68A416-CF97-4024-BA52-7F1910B06ED9; jkzlAn_channelid=9000370; jkzlAn_p=-1; jkzlAn_c=-1; jkzlAn_utm_source=0.0.h.1026.bus010.0__0.0.h.1026.bus010.0; YiHu_UserJosn=eyJBY2NvdW50U24iOiIxNDg1MjgxMjkiLCJDYXJkTnVtYmVyIjoiMjA3ODYzMTUzMyIsIkxvZ2luSWQiOiJvZDBBandKMGVvZERZWUE0cFVmRFJVQ0lJbThFIiwiVXNlck5hbWUiOiIiLCJTZWNTdHIiOiI4MEI0RUFEN0NDOTY1M0YxQkQ1MjVBM0VGNEM5MkNGRCJ9; TOKEN_5D0161F2EB225D58BD7D4CE01260C0E2=C600554136584217A36C13CF9683F91E; YIHU_SCALE_myAccessToken=C600554136584217A36C13CF9683F91E; jkzlAn_userid=C5E4A1359B42420CA64C3CCAF3BF017C; jkzlAn_ct=1660183326860; YIHU_SCALE_my_user_info20200212=snmlra59dqqzdHevsX7Zm4-5gcubZY2onaiyqYLPoM6yibVqr41-Z7OEf22tn92bj5R52pN3bGSbua6gnM56m66fra2vs5xls6p7abGws5uCpX3Um2Sbo5vN0J-Cz6DOx2e1rbKQpWa5mnikxmi4d424n6OHenmJk822h4-6f6-4jJRqs4x-pq-ejLK-jrCBj7lkzYKcppyCy9udnb1_0cig0KGqo6Sct6qMfrJ7q6qD3IiWipyIrIemrauKlXaXs3qxsLJpg3W4moR7tqCnqoSSgMqFdYGmm5TIpJvRg5rIfLmfsKJ-ZbOZf6uto6ycj5SJ25xjiamalLqpgs-gzravva2ufYpktHR7srKgu2aEpnzZh2J8rYfNsayGlX-stIm9aq5pjmizhYuhsHmwY5mUidqOeZ-pnamcnYjOes6xeK6sxICLqLmHh6Gzn7CokKZ1o5qgm36Gqbqqk6qDv7yKqWbEf4uguHaAjrVm0nyYtpungpuunJ2p0J6al4eVrp_Tn7CNdqqzdINrsXyeqYPNgNqGdpBmi6bMeobPepWyebZ8so2deLh0j7C1obx5haZ02Yt2fKuHta2ngtNz1MdnmaKqo6Scs4SDbbJ6p2aFtpaShpyMnJ-zoXE
Sec-Fetch-Site: same-origin
Sec-Fetch-Mode: no-cors
Sec-Fetch-Dest: script
Referer: https://appoint.yihu.com/appoint/register/registerOrder.html?platformType=9000370&hospitalId=1040231&deptId=7175975&doctorSn=710869460&arrangeId=160023903&utm_source=0.0.h.1026.bus010.0&channelId=9000370&sceneId=&isGuahao=&fmId=hfssqngzwsy&retid=8f1adb4a37e143a885d53db93f803eeb&canreg=1
...
HTTP/1.1 200 OK
Server: nginx
Date: Thu, 11 Aug 2022 02:10:36 GMT
Content-Type: application/javascript
Connection: keep-alive
Vary: Accept-Encoding
ETag: W/"25078-1659685423000"
Last-Modified: Fri, 05 Aug 2022 07:43:43 GMT
...
function ShowBzjRemark() {
  ...
  $("#openDiv .confcontent").css({
    "max-height": docheight - 200 + "px",
    "overflow-y": "auto",
  });
    ...
    success: function (rejson) {
      ...
      if (rejson) {
        if (rejson.Code == 10000) {
          var listHtml =
            '<li data-id="0" onclick="SelDisease(this)" >未确诊</li>';
...
function SendYzm() {
  ...
  if (
    $("#liGraphAuth").length > 0 &&
    $("#liGraphAuth").css("display") != "none"
  ) {
...
function AuthIdCard(authGuidian, showAlert) {
  ...
  if (authGuidian == 1) {
    //验证监护人
    if (
      DoctorRegOrder.guardianmembersn == "" ||
      DoctorRegOrder.guardianmembersn == "0"
    ) {
  ...
  if (!ret && showAlert) {
    myLayer.confirm({
      title: "提示",
      con: "实名认证未通过，您可到个人中心-常用就诊人里进行身份验证，通过后才能使用挂号服务",
      okValue: "确定",
    });
    $("#surebtn").click(function () {
      $("#openDiv").empty();
...
var AuthConfig = {
        ...
        if (rejson) {
          if (rejson.Code == 10000) {
            ...
            for (var i in auth.AuthJson.waitChk) {
              if (
                auth.AuthJson.waitChk[i] != "0102" &&
                auth.AuthJson.waitChk[i] != "0103"
              ) {
                //!=身份实名验证
  ...
  ShowAuthWin: function () {
    ...
    var authGuardian =
      this.AuthJson.isChild == 1 && this.AuthJson.childChk == "2" ? "1" : "0"; //1认证监护人
    if (this.AuthResult[DoctorRegOrder.memberSn] == 1) {
      return true;
    }
    if (
      authGuardian == "1" &&
      this.AuthResult[DoctorRegOrder.guardianmembersn] == 1
    ) {
      return true;
    }
  ...
  ShowAuthSelectWin: function (authItem, authGuardian) {
    ...
    if (authItem.indexOf("0103") >= 0) {
      authHtml +=
        '<li data-type="0103" data-authguard="' +
        authGuardian +
        '">\
    ...
    if (authItem.indexOf("0104") >= 0) {
      authHtml +=
        '<li data-type="0104" data-authguard="' +
        authGuardian +
        '">\
    ...
    if (authItem.indexOf("0107") >= 0) {
      authHtml +=
        '<li data-type="0107" data-authguard="' +
        authGuardian +
        '">\
    ...
    switch (aType) {
      ...
      case "0106":
        if ($("#face-tip").length < 1) {
          var appTipHtml =
            '<div id="face-tip" class="face pop c-hide">\
			             <div class="auth-pop">\
  ...
  ShowAuthAntiBrush: function () {
    if (this.AuthJson.antiBrushChk.indexOf(2) >= 0) {
      //图形验证码
      if (!CheckValidateCode()) {
        myLayer.confirm({
          title: "提示",
    ...
    if (this.AuthJson.antiBrushChk.indexOf(1) >= 0) {
      //短信验证码
      if (!CheckYzm()) {
        myLayer.confirm({
          title: "提示",
