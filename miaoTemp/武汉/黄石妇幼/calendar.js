...
(function (global, oDoc, factory) {
  ...
  // 显示价格
  Calendar.prototype.renderPriceElement = function (
    currentYear,
    currentMonth,
    currentDate,
    monthCount,
    ...
    for (var i = 0; i < monthCount; i += 1) {
      ...
      for (var k = 1; k <= monthDays; ) {
        if (
          ...
          if (
            _this.priceData[priceIndex] != undefined &&
            _this.priceData[priceIndex].indexOf("剩余") > -1
          ) {
            str +=
              '<li date-formate="' +
              currentYear +
              ...
              "/" +
              k +
              '" class="active-date"><p style="font-weight:bold;">今天</p><span class="red">' +
              _this.priceData[priceIndex] +
              "</span></li>";
          } else {
            str +=
              '<li date-formate="' +
              ...
              "/" +
              k +
              '" class="disabled"><p style="font-weight:bold;">今天</p><span>' +
              (_this.priceData.length > 0
                ? _this.priceData[priceIndex]
                : "不可约") +
              "</span></li>";
          }
  ...
  // 不显示价格
  Calendar.prototype.renderNoPriceElement = function (
    currentYear,
    currentMonth,
    currentDate,
    monthCount,
    ...
    for (var i = 0; i < activeDateLen; i += 1) {
      ...
      currentActiveDate.onclick = function () {
        ...
        if (
          ...
          _this.timeArry[0] &&
          _this.timeArry[1] &&
          parseInt(_this.indexArry[1], 10) - parseInt(_this.indexArry[0], 10) <
            _this.leastDays - 1
        ) {
          _this.timeArry[1] = "";
