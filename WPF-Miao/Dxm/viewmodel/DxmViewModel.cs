...
{
    internal class DxmViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public DxmViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<DxmLogin>>("Login.json");
        ...
        {
            var selectedDept = SelectedDepartment as DxmHospital;
