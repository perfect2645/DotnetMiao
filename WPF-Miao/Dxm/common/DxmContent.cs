...
namespace Dxm.common
{
    internal class DxmContent : HttpStringContent
    {
        public DxmLogin User { get; private set; }

        public DxmContent(string baseUrl, DxmLogin user) : base(baseUrl)
        {
            User = user;
