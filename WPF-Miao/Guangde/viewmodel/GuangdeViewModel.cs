...
using Guangde.appointment;
using Guangde.Encrypt;
using Guangde.login;
...
namespace Guangde.viewmodel
{
    internal class GuangdeViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public GuangdeViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<GuangdeLogin>>("Login.json");
        ...
        {
            var selectedDept = SelectedDepartment as GuangdeHospital;
