...
namespace Guangde.common
{
    internal class GuangdeContent : HttpStringContent
    {
        public GuangdeLogin User { get; private set; }

        public GuangdeContent(string baseUrl, GuangdeLogin user) : base(baseUrl)
        {
            User = user;
