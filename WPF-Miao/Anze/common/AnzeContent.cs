...
namespace Anze.common
{
    internal class AnzeContent : HttpStringContent
    {
        public AnzeLogin User { get; private set; }

        public AnzeContent(string baseUrl, AnzeLogin user) : base(baseUrl)
        {
            User = user;
