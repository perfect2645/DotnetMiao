...
{
    internal class ScorePlayController : HttpClientBase
    {
        #region Properties
        ...
        public ScorePlayController(HttpClient httpClient) : base(httpClient)
        {
        }

        public void ActivityPlay(UserProject user)
        {
            var content = new ScorePlayContent(user);
