...
namespace Zhuzher.search
{
    ...
    internal class MiaoshaItemList
    {
        ...
        {
            var misecond = NumberUtil.IntRandom(200, 800);
            //AddMiaoshaItem(9298, 1, "阳澄湖大闸蟹蟹卡", "1658", $"{DateTimeUtil.GetToday()} 19:59:59.{misecond}");
            AddMiaoshaItem(9298, 1, "阳澄湖大闸蟹蟹卡", "1658", $"{DateTimeUtil.GetToday()} 20:00:00");
