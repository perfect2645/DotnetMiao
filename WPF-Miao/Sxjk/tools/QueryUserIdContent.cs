...
namespace Sxjk.tools
{
    internal class QueryUserIdContent : SxjkContent
    {
        ...
        protected override void BuildUrl()
        {
            ...
            UrlDic.AddOrUpdate("child_birth_date", User.BirthDay);
            UrlDic.AddOrUpdate("child_password", User.Phone);
            UrlDic.AddOrUpdate("cid", string.Empty);
            UrlDic.AddOrUpdate("child_name", User.UserName);
            UrlDic.AddOrUpdate("operation_type", "1002");
