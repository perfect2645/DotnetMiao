    ...
    public class SearchMiaoController : HttpClientBase
    {
        ...
        private void BuildOrderList(List<Dictionary<string, object>> scheduleList)
        {
            ...
            foreach (var schedule in scheduleList)
            {
                ...
                {
                    BeginTime = startTime,
                    BeginTimeEncode = ZhiEncode(startTime),
                    EndTime = endTime,
                    EndTimeEncode = ZhiEncode(endTime),
                    ...
                    PatientNameEncode = ZhiEncode(userName),
        ...
        private string ZhiEncode(string str)
        {
            var encodeStr = UnicodeConverter.Encode(str, true);

            var ZhiEncode = encodeStr.Replace("-", "%3A");
            ZhiEncode = ZhiEncode.Replace("%", "%25");
