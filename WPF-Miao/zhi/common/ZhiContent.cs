...
namespace Zhi.common
{
    internal class ZhiContent : HttpStringContent
    {
        public ZhiContent(string url) : base(url)
        {
        ...
        {
            AddHeader("Host", "www.szZhirmyy.com");
            AddHeader("Connection", "keep-alive");
            AddHeader("Accept", "application/json, text/plain, */*");
            AddHeader("Origin", "http://www.szZhirmyy.com");
            ...
            AddHeader("Referer", $"http://www.szZhirmyy.com/wechatclient/?openId={MainSession.OpenId}");
