...
{
    internal class ShangyuViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public ShangyuViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<ShangyuLogin>>("Login.json");
        ...
        private void ExecuteLogin()
        {
            ...
            var loginData = new ShangyuLogin()
            {
        ...
        private Order BuildOneOrder(ShangyuLogin user, string date, string timeId)
        {
        ...
        {
            var selectedDept = SelectedDepartment as ShangyuHospital;
