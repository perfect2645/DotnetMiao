...
{
    internal class B114Content : HttpStringContent
    {
        public B114Login User { get; private set; }

        public B114Content(string baseUrl, B114Login user) : base(baseUrl)
        {
            User = user;
        ...
        private void BuildHeader()
        {
            ...
            AddHeader("Cookie", User.DmxcxToken);
