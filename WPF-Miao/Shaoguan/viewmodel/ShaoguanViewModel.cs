...
{
    internal class ShaoguanViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<ShaoguanLogin>>("Login.json");
        ...
        private void ExecuteLogin()
        {
            ...
            var loginData = new ShaoguanLogin()
            {
        ...
        private Order BuildOneOrder(ShaoguanLogin user, string date, string timeId)
        {
        ...
        {
            var selectedDept = SelectedDepartment as ShaoguanHospital;
