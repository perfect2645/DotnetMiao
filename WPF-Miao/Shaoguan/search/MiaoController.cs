...
namespace Shaoguan.search
{
    internal class MiaoController : HttpClientBase
    {
        ...
        public void SearchMiaoAsync(string date, ShaoguanLogin user)
        {
            Date = date;
            Task.Factory.StartNew(() => SearchMiao(date, user));
        }

        public bool SearchMiao(string date, ShaoguanLogin user)
        {
            Date = date;
            try
            {
        ...
        private bool SaveMiao(JsonElement data, ShaoguanLogin user)
        {
        ...
        private Order BuildOneOrder(ShaoguanLogin user, string date, Schedule schedule)
        {
