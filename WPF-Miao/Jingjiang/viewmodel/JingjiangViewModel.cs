...
{
    internal class JingjiangViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public JingjiangViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<JingjiangLogin>>("Login.json");
