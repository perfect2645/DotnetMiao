...
using Dongxihu.cancel;
using Dongxihu.login;
using Dongxihu.search;
...
namespace Dongxihu.viewmodel
{
    internal class DongxihuViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public DongxihuViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<DongxihuLogin>>("Login.json");
        ...
        private void ExecuteLogin()
        {
            ...
            var loginData = new DongxihuLogin()
            {
        ...
        private Order BuildOneOrder(DongxihuLogin user, string date, string timeId)
        {
        ...
        {
            var selectedDept = SelectedDepartment as DongxihuHospital;
