...
{
    internal class TongzhouViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public TongzhouViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        private void ExecuteLogin()
        {
            ...
            var loginData = new TongzhouLogin()
            {
        ...
        private Order BuildOneOrder(TongzhouLogin user, string date, string timeId)
        {
        ...
        {
            var selectedDept = SelectedDepartment as TongzhouHospital;
