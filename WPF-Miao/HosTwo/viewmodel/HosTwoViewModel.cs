...
{
    internal class HosTwoViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public HosTwoViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            var selectedDept = SelectedDepartment as HosTwoHospital;
