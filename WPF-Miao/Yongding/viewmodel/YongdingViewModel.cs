...
{
    internal class YongdingViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public YongdingViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<YongdingLogin>>("Login.json");
