...
namespace Dayim.viewmodel
{
    internal class DayimViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public DayimViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<DayimLogin>>("Login.json");
        ...
        {
            var selectedDept = SelectedDepartment as DayimHospital;
