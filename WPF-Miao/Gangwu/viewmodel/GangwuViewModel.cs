...
namespace Gangwu.viewmodel
{
    internal class GangwuViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public GangwuViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<GangwuLogin>>("Login.json");
