...
{
    internal class PuzhouViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public PuzhouViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<PuzhouLogin>>("Login.json");
        ...
        {
            var selectedDept = SelectedDepartment as PuzhouHospital;
