...
namespace Shishi.search
{
    internal class MiaoController : HttpClientBase
    {
        ...
        public void SearchMiaoAsync(string date, ShishiLogin user)
        {
            Date = date;
            Task.Factory.StartNew(() => SearchMiao(date, user));
        }

        public bool SearchMiao(string date, ShishiLogin user)
        {
            Date = date;
            try
            {
        ...
        private bool CheckTime(JsonElement data, ShishiLogin user)
        {
