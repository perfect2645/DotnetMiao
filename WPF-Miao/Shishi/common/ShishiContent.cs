...
namespace Shishi.common
{
    internal class ShishiContent : HttpStringContent
    {
        public ShishiLogin User { get; private set; }

        public ShishiContent(string url, ShishiLogin user) : base(url)
        {
            User = user;
            BuildHeader();
        }
