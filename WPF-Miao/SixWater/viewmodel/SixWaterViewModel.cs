...
{
    internal class SixWaterViewModel : OnTimeViewModel
    {
        #region Properties
        ...
        public SixWaterViewModel(LogPanel logPanel) : base(logPanel)
        {
            InitCommands();
            InitStaticData();
        ...
        {
            MainSession.Users = FileReader.DeserializeFile<List<SixWaterLogin>>("Login.json");
        ...
        {
            var selectedDept = SelectedDepartment as SixWaterHospital;
